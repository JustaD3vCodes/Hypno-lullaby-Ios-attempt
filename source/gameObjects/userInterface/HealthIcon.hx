		...
		if (this.char != char || (newPlayer != null && newPlayer != isPlayer))
		{
			...
			switch (char) {
				...
				case 'abomination-hypno':
					...
					animatedIcon = true;
				case 'gffisk':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-' + iconPath, 'shitpost');
				...
				case 'wigglytuff': 
					...
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-wigglytuff');
				...
				case 'jigglyfront':
					//offsetY = -16;
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-jigglypuff');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
				...
				case 'lord-x' | 'mx':
					offsetX = 24;
					offsetY = -16;
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-' + iconPath);
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
					...
					updateHitbox();
				case 'beelze':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-beelze');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
				...
				case 'smol-hypno':
					...
					animation.play(char);
				case 'alexis':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-alexis');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
					...
					updateHitbox();
				case 'glitchy-bf':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-bf');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
				...
				case 'steven-front' | 'steven-bed' | 'steven-fp' | 'steven-start':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-steven');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
				...
				case 'mike-bed' | 'mike-fp':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-mike');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
					...
					updateHitbox();
				case 'grey' | 'grey-cold':
					var iconGraphic:FlxGraphic = Paths.loadImage('icons/icon-grey');
					loadGraphic(iconGraphic, true, Std.int(iconGraphic.width / 2), iconGraphic.height);
